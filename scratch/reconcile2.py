...
# Only compare trades from after 2026-05-05 04:00:00 to avoid the boundary cascade
start_date = "2026-05-05 04:00:00"

livetest_df = livetest_df[livetest_df["entry_time"] >= start_date].copy()
backtest_df = backtest_df[(backtest_df["entry_time"] >= start_date) & (backtest_df["entry_time"] <= livetest_df["entry_time"].max())].copy()
