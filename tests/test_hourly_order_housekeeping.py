...
def _recovery_stub(executions, *, ledger_pos=None, cancel_by_ids=1):
    ...
    # seed path resolves cooldown_arming from strategy.config, which is a
    # real dict on every real strategy — absent field = "all" (the
    # pre-ticket default this fence pins).
    lt.strategy.config = {}
